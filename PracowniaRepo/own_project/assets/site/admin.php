...
<body>
 ...
 $conn=mysqli_connect('127.0.0.1','root','','netlib'); 
            ...
            $date=$_POST['date'];
            $category=$_POST['category'];
            $sql="INSERT INTO `movie`(`image`, `vid_link`, `decs`, `movie_id`, `title`, `date`, `category`) VALUES ('$image','$vid_link','$desc','$movie_id','$title','$date','$category');";
            $query=mysqli_query($conn, $sql);
        }
        echo'
        
         <form action="" method="POST">
            image<input type="text" name="image" class="image" required>
